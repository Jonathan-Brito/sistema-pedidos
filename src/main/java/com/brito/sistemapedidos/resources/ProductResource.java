...
import com.brito.sistemapedidos.dtos.ProductDTO;
import com.brito.sistemapedidos.resources.utils.URL;
import com.brito.sistemapedidos.services.ProductService;
...
public class ProductResource {
	...
	public ResponseEntity<Product> findById(@PathVariable Integer id){
		...
		Product optional = productService.findById(id);
